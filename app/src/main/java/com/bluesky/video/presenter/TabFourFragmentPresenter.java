...
import com.bluesky.video.presenter.contract.TabFourFragmentContract;
...
public class TabFourFragmentPresenter extends RxPresenter<TabFourFragmentContract.View>implements TabFourFragmentContract.Presenter{

    private RetrofitHelper mRetrofitHelper;
    @Inject
    public TabFourFragmentPresenter(RetrofitHelper retrofitHelper) {
