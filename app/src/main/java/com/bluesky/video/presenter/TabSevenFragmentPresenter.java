...
public class TabSevenFragmentPresenter extends RxPresenter<TabSevenFragmentContract.View>implements TabSevenFragmentContract.Presenter{

    private RetrofitHelper mRetrofitHelper;
    @Inject
    public TabSevenFragmentPresenter(RetrofitHelper retrofitHelper) {
