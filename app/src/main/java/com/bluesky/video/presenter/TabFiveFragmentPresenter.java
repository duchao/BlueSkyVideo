...
public class TabFiveFragmentPresenter extends RxPresenter<TabFiveFragmentContract.View>implements TabFiveFragmentContract.Presenter{

    private RetrofitHelper mRetrofitHelper;
    @Inject
    public TabFiveFragmentPresenter(RetrofitHelper retrofitHelper) {
