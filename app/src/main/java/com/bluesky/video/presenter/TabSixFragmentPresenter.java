...
import com.bluesky.video.presenter.contract.TabSixFragmentContract;
...
public class TabSixFragmentPresenter extends RxPresenter<TabSixFragmentContract.View>implements TabSixFragmentContract.Presenter{

    private RetrofitHelper mRetrofitHelper;
    @Inject
    public TabSixFragmentPresenter(RetrofitHelper retrofitHelper) {
