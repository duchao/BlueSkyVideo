...
public class TabSevenFragment extends BaseMvpFragment<TabSevenFragmentPresenter> implements TabSevenFragmentContract.View {
    ...
    protected int getLayout() {
        return R.layout.fragment_tab_seven;
    }
